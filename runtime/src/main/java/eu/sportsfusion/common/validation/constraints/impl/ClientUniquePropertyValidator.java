...
import eu.sportsfusion.common.validation.constraints.ClientUniqueProperty;
...
@Vetoed
@Dependent
public class ClientUniquePropertyValidator implements ConstraintValidator<ClientUniqueProperty, Object> {
    ...
    public void initialize(ClientUniqueProperty constraintAnnotation) {
    ...
    public boolean isValid(Object object, ConstraintValidatorContext constraintContext) {
        ...
        try {
            ...
            String jql = "select e from " + object.getClass().getSimpleName() + " e where e." + fieldName + "= :p and e.clientId = :clientId";
            ...
            Query query = em.createQuery(jql).setParameter("p", getFieldValue(object, fieldName)).setParameter("clientId", getFieldValue(object, "clientId"));
